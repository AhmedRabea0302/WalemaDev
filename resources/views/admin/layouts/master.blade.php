...
<html lang="en" dir="rtl">
    ...
    <head>
        ...
        <link rel="stylesheet" href="vendor/pace-1.0.2/themes/red/pace-theme-loading-bar.css">
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid">
        ...
        <script src="{{asset('assets/admin/global/scripts/ajax-validation.js')}}" type="text/javascript"></script>
